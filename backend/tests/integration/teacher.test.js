...
describe('Teacher Management API', () => {
  ...
  describe('GET /api/teachers', () => {
    test('should get all teacher', async () => {
      ...
      expect(response.body.data.teachers.length).toBeGreaterThanOrEqual(2);
    ...
    test('should support pagination', async () => {
      ...
      Assertions.assertSuccess(response, 200);
      expect(response.body.data.teachers.length).toBeLessThanOrEqual(3);
    });
    ...
    test('should filter by department', async () => {
      ...
      Assertions.assertSuccess(response, 200);
      response.body.data.teachers.forEach(teacher => {
    ...
    test('should search by name', async () => {
      ...
      Assertions.assertSuccess(response, 200);
      expect(response.body.data.teachers.length).toBeGreaterThan(0);
    });
